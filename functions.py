...
def display_letters_random(text_box, results_box):
...
# Used in modes 1 and 2
def longest_words(letters: str) -> list:
    """
    Creates a list of the longest words based on available letters

    :param letters: Available letters to make words from
    :return: A list of longest words
    """
...
def display_longest_words(letters, text_box):
    words = longest_words(letters)
    text_box.delete("1.0", tk.END)
    for word in words:
        text_box.insert("1.0", word + "\n")
